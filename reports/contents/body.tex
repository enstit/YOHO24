...
\section[YOHO model]{YOHO model}
	...
	\begin{frame}{YOHO model}
		...
		Presented in 2021, \textbf{YOHO}\footcite{Venkatesh_2022} is a lightweight real-time algorithm for \textit{audio segmentation} and \textit{sound event detection}:
		\begin{itemize}
			\item it aims to detect acoustic classes and their temporal boundaries by treating the problem as a regression task;
		\end{itemize}
	...
	\begin{frame}{Input shape}
		...
		\begin{figure}
			...
			\caption{An example of mel-spectogram.}
