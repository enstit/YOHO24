	...
	\begin{frame}{Conclusions}
		\begin{figure}
			...
			\begin{tikzpicture}
				...
				\node[draw,align=center,fill=white,inner sep=1pt,font = {\scriptsize}] at (3.75,.2) {Second\\month};
    		
				\draw[thick] (4.25,0) -- (4.25,5.65);

				\node[draw,align=center,fill=white,inner sep=1pt,font = {\scriptsize}] at (4.85,.2) {Third\\month};
