...
class AudioDataset(Dataset):
  def __init__(self, file_paths, labels, input_shape, output_shape, n_mels=64, fmax=7500):
    """
  ...
  def __getitem__(self, idx):
    ...
    if mel_spec.shape[1] < self.input_shape[2]:
        ...
        """
        mel_spec = np.pad(mel_spec, ((0,0), (0, self.input_shape[2] - mel_spec.shape[1])), mode='constant')
